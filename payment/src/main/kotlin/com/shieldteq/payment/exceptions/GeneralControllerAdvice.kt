...
import com.shieldteq.payment.dtos.response.ErrorResponseDTO
...
class GeneralControllerAdvice : ResponseEntityExceptionHandler() {
    ...
    fun handleGlobalException(e: PaymentNotFoundException, w: WebRequest): ErrorResponseDTO {
    ...
    fun handleItemNotFoundException(e: PaymentNotFoundException, w: WebRequest): ErrorResponseDTO {
